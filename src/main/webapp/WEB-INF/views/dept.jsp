...
<input id="gritter-light" checked="" type="checkbox" class="ace ace-switch ace-switch-5"/><body>
    ...
    <form id="deptForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                ...
                <td><input type="text" name="deptSeq" id="deptSeq" value="1" class="text ui-widget-content ui-corner-all"></td>
            </tr>
            <tr>
    ...
    <form id="userForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                ...
                <td><input type="text" name="userEmail" id="userEmail" value="" class="text ui-widget-content ui-corner-all"></td>
            </tr>
            <tr>
                <td><label for="userTelephone">电话</label></td>
                <td><input type="text" name="userTelephone" id="userTelephone" value="" class="text ui-widget-content ui-corner-all"></td>
            </tr>
            <tr>
                <td><label for="userStatus">状态</label></td>
                <td>
                    <select id="userStatus" name="userStatus" data-placeholder="选择状态" style="width: 150px;">
    ...
    {{#deptList}}
        <li class="dd-item dd2-item dept-name" id="dept_{{id}}" href="javascript:void(0)" data-id="{{id}}">
            ...
            <span style="float:right;">
                ...
                &nbsp;
                <a class="red dept-delete" href="#" data-id="{{id}}" data-name="{{deptName}}">
...
<script type="application/javascript">
    $(function () {
        ...
        loadDeptTree(); // load department tree
                ...
                $("#dialog-dept-form").dialog({
                    ...
                    open: function(event, ui) {
                        ...
                        if (targetDept) {
                            ...
                            $("#deptSeq").val(targetDept.deptSeq);
        ...
        function handleDeptSelected(deptId) {
            if (lastClickDeptId != -1) {
                var prevDept = $("#dept_" + lastClickDeptId + " .dd2-content:first");
                prevDept.removeClass("btn-yellow");
                prevDept.removeClass("no-hover");
            }
                ...
                if(result.data.total > 0) {
                    var rendered = Mustache.render(userListTemplate, {
                        ...
                        "showDeptName": function() {
                            return deptMap[this.deptId].deptName;
                        },
                        "showStatus": function() {
                            return this.userStatus == 1 ? '有效' : (this.userStatus == 0 ? '无效' : '删除');
                        },
                        "bold": function() {
                ...
                $("#dialog-user-form").dialog({
                    ...
                    open: function(event, ui) {
                        ...
                        if(targetUser) {
                            ...
                            $("#userEmail").val(targetUser.userEmail);
                            $("#userTelephone").val(targetUser.userTelephone);
        ...
        // recursively render the department tree for selection
        function recursiveRenderDeptSelect(deptList, level) {
            ...
            if (deptList && deptList.length > 0) {
                $(deptList).each(function (i, dept) {
                    ...
                    optionStr += Mustache.render("<option value='{{id}}'>{{name}}</option>", {id: dept.id, name: blank + dept.deptName});
